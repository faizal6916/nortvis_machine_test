...
List<DishModel> dishesFromJson(String str) => List<DishModel>.from(json.decode(str).map((x) => DishModel.fromJson(x)));

String dishesToJson(List<DishModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
